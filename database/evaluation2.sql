...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '企业表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_enterprise
-- ----------------------------
INSERT INTO `tb_enterprise` VALUES (2, 'XXX公司', '张三', '18246602913', '广西北海市银海区银滩镇南珠大道9号', '500', '20万元', '2023-05-01', 2);
INSERT INTO `tb_enterprise` VALUES (11, '制造业公司名称', '法人代表', '15015015015', '制造业', '制造业规模', '50万', '2022-02-03', 41);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价记录表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_testrecord
-- ----------------------------
INSERT INTO `tb_testrecord` VALUES (1, 7, 1, 4, 1);
INSERT INTO `tb_testrecord` VALUES (2, 7, 2, 10, 1);
INSERT INTO `tb_testrecord` VALUES (3, 5, 3, 15, 1);
INSERT INTO `tb_testrecord` VALUES (4, 5, 4, 21, 1);
INSERT INTO `tb_testrecord` VALUES (5, 7, 5, 28, 1);
...
CREATE TABLE `tb_testreport`  (
  ...
  `user_id` int NOT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '测试报告表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_testreport
-- ----------------------------
INSERT INTO `tb_testreport` VALUES (1, 12.27, '[{\"id\":1,\"name\":\"能力域\",\"score\":12.27}, {\"id\":2,\"name\":\"组织引领\"}, {\"id\":3,\"name\":\"场景实现\"}, {\"id\":4,\"name\":\"其他\"}]', '[{\"id\":1,\"name\":\"数据域\",\"score\":6.27}, {\"id\":2,\"name\":\"网络域\",\"score\":6.0}, {\"id\":3,\"name\":\"生产管理域域\"}, {\"id\":4,\"name\":\"物流域\"}, {\"id\":5,\"name\":\"信息安全域\"}, {\"id\":6,\"name\":\"制度类\"}, {\"id\":7,\"name\":\"结构类\"}, {\"id\":8,\"name\":\"管理类\"}, {\"id\":9,\"name\":\"运维场景分析\"}, {\"id\":10,\"name\":\"服务域\"}, {\"id\":11,\"name\":\"恢复类\"}]', '应将数据管理与ai相结合，形成数据管理自动化\n应采用多种方式采集，提高采集效率，同时应用ai采集，减少人工成本\n升级传递方式，使用oa、ERP等管理系统，可以使用数据库实现数据库共享传输\n升级管理技术，利用ai信息系统进行数据管理\n增加风险评估频率，实现实时监控\n', '[]', '2023-05-01 08:04:21', '2023-05-01 11:19:34', 2);
...
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_user` VALUES (18, 'zhang9', '123456', 'https://cdn.qingk.com/cover/84bc9daf-c245-49dc-9bcf-8f447afbfe84.png');
INSERT INTO `tb_user` VALUES (19, 'zhang6', '123456', NULL);
INSERT INTO `tb_user` VALUES (21, 'zhang7', '123456', NULL);
INSERT INTO `tb_user` VALUES (23, 'zhang8', '123456', NULL);
INSERT INTO `tb_user` VALUES (33, 'li44', '123456', NULL);
INSERT INTO `tb_user` VALUES (34, '1231231', '23123', NULL);
INSERT INTO `tb_user` VALUES (35, '123123', '123123', NULL);
INSERT INTO `tb_user` VALUES (36, 'li4', '123456', NULL);
INSERT INTO `tb_user` VALUES (37, '502', '123456', NULL);
INSERT INTO `tb_user` VALUES (38, '503', '123456', NULL);
INSERT INTO `tb_user` VALUES (39, '501', '123456', NULL);
INSERT INTO `tb_user` VALUES (40, '500', '123456', NULL);
INSERT INTO `tb_user` VALUES (41, '504', '123456', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户-角色关联表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_user_role` VALUES (8, 19, 2);
INSERT INTO `tb_user_role` VALUES (9, 21, 2);
INSERT INTO `tb_user_role` VALUES (10, 23, 2);
INSERT INTO `tb_user_role` VALUES (11, 33, 2);
INSERT INTO `tb_user_role` VALUES (12, 34, 2);
INSERT INTO `tb_user_role` VALUES (13, 35, 2);
INSERT INTO `tb_user_role` VALUES (14, 36, 2);
INSERT INTO `tb_user_role` VALUES (15, 37, 2);
INSERT INTO `tb_user_role` VALUES (16, 38, 2);
INSERT INTO `tb_user_role` VALUES (17, 39, 2);
INSERT INTO `tb_user_role` VALUES (18, 40, 2);
INSERT INTO `tb_user_role` VALUES (19, 41, 2);
