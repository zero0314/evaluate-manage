...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价模块表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_enterprise`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name_unique`(`name` ASC) USING BTREE,
  UNIQUE INDEX `userid_unique`(`user_id` ASC) USING BTREE,
  CONSTRAINT `enterprise_user` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '企业表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_enterprise
-- ----------------------------
INSERT INTO `tb_enterprise` VALUES (2, 'XXX公司', '张三1111', '18246602913', '广西北海市银海区银滩镇南珠大道9号', '500', '20万元', '2023-05-01', 2);
INSERT INTO `tb_enterprise` VALUES (19, '12312', '123123', '23123', '12312', '31231', '123123', '3123', 55);
INSERT INTO `tb_enterprise` VALUES (20, '312', '1231', '123', '231123', '23', '132', '1332', 56);
INSERT INTO `tb_enterprise` VALUES (21, '123', '12', '321', '312312', '312', '123', '1313', 57);
INSERT INTO `tb_enterprise` VALUES (22, '123123', '2312', '31', '313', '231', '31', '123', 58);
INSERT INTO `tb_enterprise` VALUES (23, '14546', '123123', '2131', '12313', '1231', '123', '123123', 59);
INSERT INTO `tb_enterprise` VALUES (24, '1', '31', '23123', '312213', '31', '123', '12312', 60);
INSERT INTO `tb_enterprise` VALUES (25, '11', '112323', '1231', '123', '123', '123', '123132', 61);
INSERT INTO `tb_enterprise` VALUES (26, '32', '3', '21', '2332', '2332', '3223', '33', 62);
INSERT INTO `tb_enterprise` VALUES (27, '2', '123', '231', '23231', '321', '3123', '1231', 63);
...
-- Records of tb_role
-- ----------------------------
INSERT INTO `tb_role` VALUES (8, '1111');
INSERT INTO `tb_role` VALUES (1, 'admin');
INSERT INTO `tb_role` VALUES (7, 'text1');
INSERT INTO `tb_role` VALUES (6, 'text11');
...
CREATE TABLE `tb_testpoint`  (
  ...
  CONSTRAINT `point_type` FOREIGN KEY (`type_id`) REFERENCES `tb_testtype` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价点表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_testrecord`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `point_report_unique`(`point_id` ASC, `report_id` ASC) USING BTREE,
  ...
  CONSTRAINT `record_point_id` FOREIGN KEY (`point_id`) REFERENCES `tb_testpoint` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `record_report_id` FOREIGN KEY (`report_id`) REFERENCES `tb_testreport` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `record_select_id` FOREIGN KEY (`select_id`) REFERENCES `tb_testselect` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 136 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价记录表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_testrecord
-- ----------------------------
INSERT INTO `tb_testrecord` VALUES (131, 7, 1, 4, 29);
INSERT INTO `tb_testrecord` VALUES (132, 7, 2, 10, 29);
INSERT INTO `tb_testrecord` VALUES (133, 5, 3, 15, 29);
INSERT INTO `tb_testrecord` VALUES (134, 5, 4, 21, 29);
INSERT INTO `tb_testrecord` VALUES (135, 9, 5, 29, 29);
...
CREATE TABLE `tb_testreport`  (
  ...
  `createtime` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '开始时间',
  `endtime` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '结束时间',
  `user_id` int NOT NULL COMMENT '用户id',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `report_user_id`(`user_id` ASC) USING BTREE,
  CONSTRAINT `report_user_id` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '测试报告表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_testreport
-- ----------------------------
INSERT INTO `tb_testreport` VALUES (29, 13.27, '[{\"id\":1,\"name\":\"能力域\",\"score\":13.27}, {\"id\":2,\"name\":\"组织引领\",\"score\":0}, {\"id\":3,\"name\":\"场景实现\",\"score\":0}, {\"id\":4,\"name\":\"其他\",\"score\":0}]', '[{\"id\":1,\"name\":\"数据域\",\"score\":6.27}, {\"id\":2,\"name\":\"网络域\",\"score\":7.0}, {\"id\":3,\"name\":\"生产管理域域\",\"score\":0}, {\"id\":4,\"name\":\"物流域\",\"score\":0}, {\"id\":5,\"name\":\"信息安全域\",\"score\":0}, {\"id\":6,\"name\":\"制度类\",\"score\":0}, {\"id\":7,\"name\":\"结构类\",\"score\":0}, {\"id\":8,\"name\":\"管理类\",\"score\":0}, {\"id\":9,\"name\":\"运维场景分析\",\"score\":0}, {\"id\":10,\"name\":\"服务域\",\"score\":0}, {\"id\":11,\"name\":\"恢复类\",\"score\":0}]', '应将数据管理与ai相结合，形成数据管理自动化\n应采用多种方式采集，提高采集效率，同时应用ai采集，减少人工成本\n升级传递方式，使用oa、ERP等管理系统，可以使用数据库实现数据库共享传输\n升级管理技术，利用ai信息系统进行数据管理\n', NULL, '2023-05-01 17:54:42', '2023-05-01 17:55:04', 2);
...
CREATE TABLE `tb_testselect`  (
  ...
  CONSTRAINT `select_point` FOREIGN KEY (`point_id`) REFERENCES `tb_testpoint` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价细则表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_testtype`  (
  ...
  CONSTRAINT `type_dimension` FOREIGN KEY (`dimension_id`) REFERENCES `tb_dimension` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评价域表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `tb_user` VALUES (55, '231312', '3123', NULL);
INSERT INTO `tb_user` VALUES (56, '111', '123123', NULL);
INSERT INTO `tb_user` VALUES (57, '123', '123123', NULL);
INSERT INTO `tb_user` VALUES (58, '112', '1231231', NULL);
INSERT INTO `tb_user` VALUES (59, '113', '123', NULL);
INSERT INTO `tb_user` VALUES (60, '12312', '23123123', NULL);
INSERT INTO `tb_user` VALUES (61, '123133333', '23123', NULL);
INSERT INTO `tb_user` VALUES (62, '1231233', '3213', NULL);
INSERT INTO `tb_user` VALUES (63, '11134', '11', NULL);
...
CREATE TABLE `tb_user_role`  (
  ...
  CONSTRAINT `role_id` FOREIGN KEY (`role_id`) REFERENCES `tb_role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `tb_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户-角色关联表' ROW_FORMAT = DYNAMIC;
